...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validateForm()) {
      showToast("Missing Information", "Please complete all required fields.", "info");
      return;
    }
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">support@scminsights.com</p>
                  <p className="text-gray-600 text-sm">sales@scminsights.com</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-teal-100 flex items-center justify-center shrink-0">
                  <HugeiconsIcon icon={CallIcon} size={20} className="text-teal-600" />
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center shrink-0">
                  <HugeiconsIcon icon={Location01Icon} size={20} className="text-indigo-600" />
                </div>
                <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full h-12 pl-12 pr-4 bg-gray-50 border ${errors.name ? "border-red-300" : "border-gray-200"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full h-12 pl-12 pr-4 bg-gray-50 border ${errors.email ? "border-red-300" : "border-gray-200"
                          } rounded-xl text-sm placeholder-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 hover:border-blue-300 transition-all`}
                      />
                    </div>
                    {errors.email && (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <HugeiconsIcon icon={CallIcon} size={18} className="text-gray-400" />
                      </div>
                      <input
                        type="tel"
                        name="phone"
                        ...
                        className={`w-full h-12 pl-12 pr-4 bg-gray-50 border ${errors.phone ? "border-red-300" : "border-gray-200"
                          } rounded-xl text-sm placeholder-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 hover:border-blue-300 transition-all`}
                      />
                    </div>
                    {errors.phone && (
                ...
                <div>
                  ...
                  <div className="relative">
                    <div className="absolute top-4 left-4 pointer-events-none">
                      <HugeiconsIcon icon={Message01Icon} size={18} className="text-gray-400" />
                    </div>
                    <textarea
                      name="message"
                      ...
                      rows={5}
                      className={`w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.message ? "border-red-300" : "border-gray-200"
